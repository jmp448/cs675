...
def param_sweep_best(args):
    ...
    #     train(args)
    # n2_channel_vals = [50, 60, 70, 80, 100]
    # for v in n2_channel_vals:
    #     args.best_n2_channels = v
    #     args.log_file = "logs/best-n2chan={}.csv".format(v)
    #     args.model_save = "models/best-n2chan={}.torch".format(v)
    ...
    # batch_sizes = [10, 20, 40, 70, 140, 200, 280]
    # for v in batch_sizes:
    #     args.batch_size = v
    #     args.log_file = "logs/best-batchsize={}.csv".format(v)
    #     args.model_save = "models/best-batchsize={}.torch".format(v)
    #     train(args)
    batch_sizes = [320, 400]
    for v in batch_sizes:
        args.batch_size = v
