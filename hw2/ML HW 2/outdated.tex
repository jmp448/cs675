...
\newquestion
\section*{\arabic{QuestionCounter}) Decision Trees (15 points)} {
...
\newpage
\item (3 points) Apply the decision tree learned in part 1 of this question to
...
\item (5 points) For the training dataset in part 1, can any of the methods
...
\newquestion
\section*{\arabic{QuestionCounter}) Kernels (15 points) } {
...
\newquestion
\section*{\arabic{QuestionCounter}) \textsc{AdaBoost} (20 points) } {
...
\item (3 points) Show your work for the first $2$ iterations of \textsc{AdaBoost}. You must use the
...
\item (3 points) After running \textsc{AdaBoost} for 10 iterations, what is the error rate of the ensemble?
